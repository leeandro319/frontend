  ...
  return(
      ...
      <div className="content-card-user">
          ...
          <div className="infos-card-user">          
            <p><AlternateEmailIcon />{props.email ? props.email :'Não Definido'}</p>
            <p><PeopleAltIcon />{props.followers} followers</p>
            <p><SwapHorizontalCircleIcon />{props.following} following</p>
        </div>
      </div>
      </Link>
      </UsersSearch>
