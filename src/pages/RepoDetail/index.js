...
const RepoDetail = () => {
  ...
  useEffect(() => {
    api
      .get(`repos/${params.detail}`)
      .then((res) => {
        const repo = res.data;
        setDetailsRepo(repo);
      })
      .catch((error) => {
        setErrorPage("este repositório não existe");
      });
  }, [params.detail]);
        ...
        <ContentInfoDev>
          ...
          <div className="dates-repo">
            ...
            <p>
              ...
              {dateFormater(datailsRepo.created_at)}
            </p>
            <p>
            ...
            <p>
              ...
              {dateFormater(datailsRepo.pushed_at)}
            </p>
          </div>
          <div className="repo-statis-link">
            ...
            <a href={datailsRepo.svn_url} target="_blank" rel="noreferrer">
              Acessar Repositório
            </a>
          </div>
        </ContentInfoDev>
